        ...
        <div class="hero-content">
          <div class="hero-left">
            ...
            <p class="hero-description">
              Cuidar é parte do nosso DNA. Aqui, cada ambiente é pensado para acolher, proteger e
              estimular. Garantimos uma jornada de aprendizagem estruturada, com acompanhamento
              contínuo, tecnologia segura e equipe comprometida com o desenvolvimento integral do
              aluno.
            </p>
            <p class="hero-description">
              Mais que uma escola, somos um
              <strong>espaço de crescimento com valores, fé, respeito e propósito. </strong>
            </p>
            ...
            <div class="hero-buttons">
              ...
              <button @click="currentPage = 'nossahistoria'" class="btn-saiba-mais">
                Nossa História
              </button>
            </div>
          </div>
        ...
        <div class="about-content">
          ...
          <div class="about-cards">
            ...
            <div class="card">
              ...
              <p>
                Unimos metodologias ativas, STEAM, Reggio Emilia e Tecnologia Educacional para
                desenvolver o pensamento crítico, a criatividade, o protagonismo e o espírito
                investigativo - preparando nossos alunos para os desafios do século XXI, sem perder
             ...
             <p>
                 Com o material da <strong>Geekie</strong> e uma proposta pedagógica que integra
                  <strong
                    ...
                    gamificação,</strong
                  >
                  nossos alunos desenvolvem competências como
        ...
        <div class="hero-content">
          ...
          <div class="hero-right">
            <div class="ensmed-image">
              <img src="../public/foto6.jpg" alt="Ensino Médio" class='ensmed-image' />
            </div>
          </div>
        </div>
      </section>
...
.area-card .area-emoji {
  width: 200px; /* aumenta horizontalmente */
